...
$(document).ready(function () {
  ...
  require(['Canvas-Flowmap-Layer/CanvasFlowmapLayer', 'esri/Graphic', 'esri/Map', 'esri/views/MapView', "esri/layers/TileLayer", 'dojo/domReady!'], function (CanvasFlowmapLayer, Graphic, EsriMap, MapView) {
    ...
    view.when(function () {
      $("#loading").fadeOut();
      $("#detail").html('Please choose departure and destination.<br />请选择出发和到达地点，点击左侧按钮开始搜索航线。'); // use Papa Parse to load and read the CSV data
